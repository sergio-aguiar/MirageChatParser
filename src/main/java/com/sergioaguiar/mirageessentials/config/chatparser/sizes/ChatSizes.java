package com.sergioaguiar.mirageessentials.config.chatparser.sizes;

import java.util.Comparator;
import java.util.HashMap;
import java.util.Map;

import com.sergioaguiar.mirageessentials.util.CobblemonSizeVariationUtils;
import com.sergioaguiar.mirageessentials.util.CobblemonSizeVariationUtils.SizeDefinition;
